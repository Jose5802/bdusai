...
for i in range(total_clients):
    ...
    if events[0][0] == ARRIVE:
        ...
        events.sort(key=lambda tup: tup[1])  # poner en el segundo elemento de la tupla
...
#report
report = open("report.csv","w")  # abro un archivo. w significa que está en formato escritura
